...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / SAMPLING\_DEPRECATED

# Variable: SAMPLING\_DEPRECATED

> `const` **SAMPLING\_DEPRECATED**: `true`

Defined in: [protocol/sampling.ts:66](https://github.com/stackific/mcp-sdk-node/blob/main/src/protocol/sampling.ts#L66)
