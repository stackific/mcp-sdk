...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / UiChannelPhase

# Type Alias: UiChannelPhase

> **UiChannelPhase** = `"awaiting-init-response"` \| `"initialized"`

Defined in: [protocol/ui-host.ts:697](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L697)
