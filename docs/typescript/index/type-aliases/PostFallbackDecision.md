...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / PostFallbackDecision

# Type Alias: PostFallbackDecision

> **PostFallbackDecision** = \{ `action`: `"retry"`; `supported?`: `string`[]; \} \| \{ `action`: `"proceed"`; \} \| \{ `action`: `"legacy-probe"`; \}

Defined in: [transport/http/responses.ts:587](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L587)
