...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / ClientIdMechanism

# Type Alias: ClientIdMechanism

> **ClientIdMechanism** = `"pre-registration"` \| `"cimd"` \| `"dcr"` \| `"prompt"`

Defined in: [protocol/authorization-flow.ts:214](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L214)
