...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / ConformanceAxis

# Type Alias: ConformanceAxis

> **ConformanceAxis** = `"role"` \| `"feature"` \| `"transport"`

Defined in: [protocol/conformance-requirements.ts:109](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/conformance-requirements.ts#L109)
