...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / ResultType

# Type Alias: ResultType

> **ResultType** = `string`

Defined in: [jsonrpc/payload.ts:37](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/jsonrpc/payload.ts#L37)
