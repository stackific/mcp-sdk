...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / StepUpActor

# Type Alias: StepUpActor

> **StepUpActor** = `"user"` \| `"client_credentials"`

Defined in: [protocol/authorization-registration.ts:808](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L808)
