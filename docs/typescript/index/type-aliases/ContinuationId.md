...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / ContinuationId

# Type Alias: ContinuationId

> **ContinuationId** = `string` \| `number` \| `boolean` \| `null` \| `ReadonlyArray`\<`unknown`\> \| `Readonly`\<`Record`\<`string`, `unknown`\>\>

Defined in: [protocol/stateless.ts:33](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/stateless.ts#L33)
