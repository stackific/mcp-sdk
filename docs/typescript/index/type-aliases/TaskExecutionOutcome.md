...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / TaskExecutionOutcome

# Type Alias: TaskExecutionOutcome

> **TaskExecutionOutcome** = `"failed"` \| `"completed"`

Defined in: [protocol/tasks-lifecycle.ts:765](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L765)
