...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / Icons

# Type Alias: Icons

> **Icons** = `z.infer`\<*typeof* [`IconsSchema`](../variables/IconsSchema.md)\>

Defined in: [types/icon.ts:53](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/icon.ts#L53)
