...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / DirectionalKind

# Type Alias: DirectionalKind

> **DirectionalKind** = `"request"` \| `"notification"` \| `"response"`

Defined in: [transport/contract.ts:130](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L130)
