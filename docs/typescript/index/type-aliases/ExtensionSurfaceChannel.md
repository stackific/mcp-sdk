...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / ExtensionSurfaceChannel

# Type Alias: ExtensionSurfaceChannel

> **ExtensionSurfaceChannel** = `"method"` \| `"meta-key"` \| `"result-type"` \| `"field"`

Defined in: [protocol/extension-mechanism.ts:216](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extension-mechanism.ts#L216)
