...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / TransportFamily

# Type Alias: TransportFamily

> **TransportFamily** = `"http"` \| `"stdio"` \| `"other"`

Defined in: [protocol/authorization.ts:56](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L56)
