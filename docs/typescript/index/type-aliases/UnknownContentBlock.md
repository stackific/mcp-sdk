...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / UnknownContentBlock

# Type Alias: UnknownContentBlock

> **UnknownContentBlock** = `object` & `Record`\<`string`, `unknown`\>

Defined in: [types/content.ts:172](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/content.ts#L172)
