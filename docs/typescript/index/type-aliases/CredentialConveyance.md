...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / CredentialConveyance

# Type Alias: CredentialConveyance

> **CredentialConveyance** = `"bearer"` \| `"environment"` \| `"best-practice"`

Defined in: [protocol/authorization.ts:93](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L93)
