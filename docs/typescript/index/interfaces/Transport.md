...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / Transport

# Interface: Transport

Defined in: [transport/contract.ts:87](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L87)
...
Defined in: [transport/contract.ts:118](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L118)
...
Defined in: [transport/contract.ts:94](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L94)
...
Defined in: [transport/contract.ts:96](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L96)
...
Defined in: [transport/contract.ts:108](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L108)
...
Defined in: [transport/contract.ts:114](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L114)
...
Defined in: [transport/contract.ts:116](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L116)
