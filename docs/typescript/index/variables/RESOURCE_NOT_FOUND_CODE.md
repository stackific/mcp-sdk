...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / RESOURCE\_NOT\_FOUND\_CODE

# Variable: RESOURCE\_NOT\_FOUND\_CODE

> `const` **RESOURCE\_NOT\_FOUND\_CODE**: `-32602` = `INVALID_PARAMS_CODE`

Defined in: [protocol/resources-read.ts:88](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources-read.ts#L88)
