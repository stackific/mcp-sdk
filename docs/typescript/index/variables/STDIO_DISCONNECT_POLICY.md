...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / STDIO\_DISCONNECT\_POLICY

# Variable: STDIO\_DISCONNECT\_POLICY

> `const` **STDIO\_DISCONNECT\_POLICY**: `object`

Defined in: [transport/contract.ts:273](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L273)
