...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / PAGINATED\_METHODS

# Variable: PAGINATED\_METHODS

> `const` **PAGINATED\_METHODS**: `Set`\<`"prompts/list"` \| `"resources/list"` \| `"tools/list"` \| `"resources/templates/list"`\>

Defined in: [protocol/pagination.ts:230](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/pagination.ts#L230)
