...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / MRTR\_PARTICIPATING\_METHODS

# Variable: MRTR\_PARTICIPATING\_METHODS

> `const` **MRTR\_PARTICIPATING\_METHODS**: `Set`\<`"prompts/get"` \| `"resources/read"` \| `"tools/call"`\>

Defined in: [protocol/multi-round-trip.ts:552](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/multi-round-trip.ts#L552)
