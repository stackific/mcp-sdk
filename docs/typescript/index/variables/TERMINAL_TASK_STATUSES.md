...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / TERMINAL\_TASK\_STATUSES

# Variable: TERMINAL\_TASK\_STATUSES

> `const` **TERMINAL\_TASK\_STATUSES**: `Set`\<`"input_required"` \| `"cancelled"` \| `"completed"` \| `"working"` \| `"failed"`\>

Defined in: [protocol/tasks.ts:233](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L233)
