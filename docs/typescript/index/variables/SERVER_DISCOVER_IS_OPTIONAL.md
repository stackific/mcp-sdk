...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / SERVER\_DISCOVER\_IS\_OPTIONAL

# Variable: SERVER\_DISCOVER\_IS\_OPTIONAL

> `const` **SERVER\_DISCOVER\_IS\_OPTIONAL**: `true`

Defined in: [protocol/negotiation.ts:81](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/negotiation.ts#L81)
