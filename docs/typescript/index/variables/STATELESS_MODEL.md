...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / STATELESS\_MODEL

# Variable: STATELESS\_MODEL

> `const` **STATELESS\_MODEL**: `object`

Defined in: [protocol/stateless.ts:76](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/stateless.ts#L76)
