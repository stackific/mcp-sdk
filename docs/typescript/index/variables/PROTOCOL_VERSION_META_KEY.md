...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / PROTOCOL\_VERSION\_META\_KEY

# Variable: PROTOCOL\_VERSION\_META\_KEY

> `const` **PROTOCOL\_VERSION\_META\_KEY**: `"io.modelcontextprotocol/protocolVersion"`

Defined in: [protocol/meta.ts:62](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/meta.ts#L62)
