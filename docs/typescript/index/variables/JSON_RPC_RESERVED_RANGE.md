...
> `const` **JSON\_RPC\_RESERVED\_RANGE**: `object`

Defined in: [protocol/errors.ts:101](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/errors.ts#L101)
