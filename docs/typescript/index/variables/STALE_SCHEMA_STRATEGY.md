...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / STALE\_SCHEMA\_STRATEGY

# Variable: STALE\_SCHEMA\_STRATEGY

> `const` **STALE\_SCHEMA\_STRATEGY**: `object`

Defined in: [transport/http/param-headers.ts:344](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/param-headers.ts#L344)
