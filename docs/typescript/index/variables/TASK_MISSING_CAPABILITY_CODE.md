...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / TASK\_MISSING\_CAPABILITY\_CODE

# Variable: TASK\_MISSING\_CAPABILITY\_CODE

> `const` **TASK\_MISSING\_CAPABILITY\_CODE**: `-32003` = `MISSING_CLIENT_CAPABILITY_CODE`

Defined in: [protocol/tasks.ts:642](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L642)
