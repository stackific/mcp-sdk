...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / RESERVED\_BARE\_KEYS

# Variable: RESERVED\_BARE\_KEYS

> `const` **RESERVED\_BARE\_KEYS**: `Set`\<`"progressToken"` \| `"traceparent"` \| `"tracestate"` \| `"baggage"`\>

Defined in: [protocol/meta.ts:39](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/meta.ts#L39)
