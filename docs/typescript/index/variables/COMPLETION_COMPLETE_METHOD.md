...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / COMPLETION\_COMPLETE\_METHOD

# Variable: COMPLETION\_COMPLETE\_METHOD

> `const` **COMPLETION\_COMPLETE\_METHOD**: `"completion/complete"`

Defined in: [protocol/completion.ts:76](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L76)
