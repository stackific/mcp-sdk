...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / DEPRECATED\_REGISTRY

# Variable: DEPRECATED\_REGISTRY

> `const` **DEPRECATED\_REGISTRY**: `ReadonlyArray`\<[`DeprecatedRegistryEntry`](../interfaces/DeprecatedRegistryEntry.md)\>

Defined in: [lifecycle/registry.ts:25](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/lifecycle/registry.ts#L25)
