...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / TasksExtensionCapabilitySchema

# Variable: TasksExtensionCapabilitySchema

> `const` **TasksExtensionCapabilitySchema**: `ZodRecord`\<`ZodString`, `ZodUnknown`\>

Defined in: [protocol/tasks.ts:110](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L110)
