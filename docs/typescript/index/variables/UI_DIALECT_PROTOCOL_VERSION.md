...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / UI\_DIALECT\_PROTOCOL\_VERSION

# Variable: UI\_DIALECT\_PROTOCOL\_VERSION

> `const` **UI\_DIALECT\_PROTOCOL\_VERSION**: `"2026-01-26"`

Defined in: [protocol/ui-host.ts:90](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L90)
