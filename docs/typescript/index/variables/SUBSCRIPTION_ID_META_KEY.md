...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / SUBSCRIPTION\_ID\_META\_KEY

# Variable: SUBSCRIPTION\_ID\_META\_KEY

> `const` **SUBSCRIPTION\_ID\_META\_KEY**: `"io.modelcontextprotocol/subscriptionId"`

Defined in: [protocol/streaming.ts:113](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/streaming.ts#L113)
