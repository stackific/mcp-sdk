...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / RESOURCE\_READ\_INTERNAL\_ERROR\_CODE

# Variable: RESOURCE\_READ\_INTERNAL\_ERROR\_CODE

> `const` **RESOURCE\_READ\_INTERNAL\_ERROR\_CODE**: `-32603`

Defined in: [protocol/resources-read.ts:106](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources-read.ts#L106)
