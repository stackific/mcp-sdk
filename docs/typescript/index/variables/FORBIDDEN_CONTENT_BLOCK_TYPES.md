...
> `const` **FORBIDDEN\_CONTENT\_BLOCK\_TYPES**: `Set`\<`string`\>

Defined in: [types/content.ts:143](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/content.ts#L143)
