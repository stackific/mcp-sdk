...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / STATELESS\_CONFORMANCE\_INVARIANTS

# Variable: STATELESS\_CONFORMANCE\_INVARIANTS

> `const` **STATELESS\_CONFORMANCE\_INVARIANTS**: `object`

Defined in: [protocol/conformance-requirements.ts:738](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/conformance-requirements.ts#L738)
