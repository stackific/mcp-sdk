...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / DUPLICATE\_INPUT\_REQUESTS\_KEY\_ERROR

# Variable: DUPLICATE\_INPUT\_REQUESTS\_KEY\_ERROR

> `const` **DUPLICATE\_INPUT\_REQUESTS\_KEY\_ERROR**: `object`

Defined in: [protocol/multi-round-trip.ts:621](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/multi-round-trip.ts#L621)
