...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / ExtensionsMapSchema

# Variable: ExtensionsMapSchema

> `const` **ExtensionsMapSchema**: `ZodRecord`\<`ZodString`, `ZodRecord`\<`ZodString`, `ZodUnknown`\>\>

Defined in: [protocol/extensions.ts:175](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L175)
