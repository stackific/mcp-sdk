...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / RESOURCE\_NOT\_FOUND\_LEGACY\_CODE

# Variable: RESOURCE\_NOT\_FOUND\_LEGACY\_CODE

> `const` **RESOURCE\_NOT\_FOUND\_LEGACY\_CODE**: `-32002`

Defined in: [protocol/errors.ts:73](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/errors.ts#L73)
