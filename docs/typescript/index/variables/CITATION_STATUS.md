...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / CITATION\_STATUS

# Variable: CITATION\_STATUS

> `const` **CITATION\_STATUS**: `object`

Defined in: [protocol/conformance-requirements.ts:1014](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/conformance-requirements.ts#L1014)
