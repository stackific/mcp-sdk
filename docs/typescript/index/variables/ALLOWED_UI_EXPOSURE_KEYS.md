...
> `const` **ALLOWED\_UI\_EXPOSURE\_KEYS**: readonly `string`[]

Defined in: [protocol/ui-host.ts:1109](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L1109)
