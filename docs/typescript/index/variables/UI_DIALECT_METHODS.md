...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / UI\_DIALECT\_METHODS

# Variable: UI\_DIALECT\_METHODS

> `const` **UI\_DIALECT\_METHODS**: `object`

Defined in: [protocol/ui-host.ts:131](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L131)
