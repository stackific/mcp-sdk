...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / UI\_MIME\_TYPE

# Variable: UI\_MIME\_TYPE

> `const` **UI\_MIME\_TYPE**: `"text/html;profile=mcp-app"`

Defined in: [protocol/ui.ts:85](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L85)
