...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / APPENDIX\_B\_RESERVED\_CODE\_SET

# Variable: APPENDIX\_B\_RESERVED\_CODE\_SET

> `const` **APPENDIX\_B\_RESERVED\_CODE\_SET**: `ReadonlySet`\<`number`\>

Defined in: [protocol/registries.ts:847](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/registries.ts#L847)
