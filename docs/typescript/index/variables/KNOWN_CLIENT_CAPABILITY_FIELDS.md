...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / KNOWN\_CLIENT\_CAPABILITY\_FIELDS

# Variable: KNOWN\_CLIENT\_CAPABILITY\_FIELDS

> `const` **KNOWN\_CLIENT\_CAPABILITY\_FIELDS**: `ReadonlySet`\<`string`\>

Defined in: [protocol/extensions.ts:357](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L357)
