...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / COMPLETION\_INVALID\_PARAMS\_CODE

# Variable: COMPLETION\_INVALID\_PARAMS\_CODE

> `const` **COMPLETION\_INVALID\_PARAMS\_CODE**: `-32602` = `INVALID_PARAMS_CODE`

Defined in: [protocol/completion.ts:101](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L101)
