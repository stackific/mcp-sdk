...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / PROTOCOL\_REVISION\_FORMAT\_RE

# Variable: PROTOCOL\_REVISION\_FORMAT\_RE

> `const` **PROTOCOL\_REVISION\_FORMAT\_RE**: `RegExp`

Defined in: [protocol/meta.ts:161](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/meta.ts#L161)
