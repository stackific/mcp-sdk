...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / TASK\_RESULT\_TYPE

# Variable: TASK\_RESULT\_TYPE

> `const` **TASK\_RESULT\_TYPE**: `"task"`

Defined in: [protocol/tasks.ts:92](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L92)
