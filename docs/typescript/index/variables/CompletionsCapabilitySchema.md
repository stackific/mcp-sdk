...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / CompletionsCapabilitySchema

# Variable: CompletionsCapabilitySchema

> `const` **CompletionsCapabilitySchema**: `ZodRecord`\<`ZodString`, `ZodUnknown`\>

Defined in: [protocol/completion.ts:128](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L128)
