...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / MetaObjectSchema

# Variable: MetaObjectSchema

> `const` **MetaObjectSchema**: `ZodRecord`\<`ZodString`, `ZodUnknown`\>

Defined in: [protocol/meta.ts:81](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/meta.ts#L81)
