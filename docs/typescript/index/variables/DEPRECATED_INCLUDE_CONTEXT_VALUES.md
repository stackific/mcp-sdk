...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / DEPRECATED\_INCLUDE\_CONTEXT\_VALUES

# ~~Variable: DEPRECATED\_INCLUDE\_CONTEXT\_VALUES~~

> `const` **DEPRECATED\_INCLUDE\_CONTEXT\_VALUES**: `Set`\<`"thisServer"` \| `"allServers"`\>

Defined in: [protocol/sampling.ts:358](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/sampling.ts#L358)
