...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / FORBIDDEN\_UI\_EXPOSURE\_KEYS

# Variable: FORBIDDEN\_UI\_EXPOSURE\_KEYS

> `const` **FORBIDDEN\_UI\_EXPOSURE\_KEYS**: readonly `string`[]

Defined in: [protocol/ui-host.ts:1092](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L1092)
