...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / RESULT\_TYPE

# Variable: RESULT\_TYPE

> `const` **RESULT\_TYPE**: `object`

Defined in: [jsonrpc/payload.ts:22](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/jsonrpc/payload.ts#L22)
