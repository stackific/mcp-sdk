...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / WELL\_KNOWN\_URI\_SCHEMES

# Variable: WELL\_KNOWN\_URI\_SCHEMES

> `const` **WELL\_KNOWN\_URI\_SCHEMES**: readonly \[`"https"`, `"file"`, `"git"`\]

Defined in: [protocol/resources-read.ts:549](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources-read.ts#L549)
