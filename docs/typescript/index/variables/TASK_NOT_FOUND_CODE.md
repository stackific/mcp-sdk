...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / TASK\_NOT\_FOUND\_CODE

# Variable: TASK\_NOT\_FOUND\_CODE

> `const` **TASK\_NOT\_FOUND\_CODE**: `-32602` = `INVALID_PARAMS_CODE`

Defined in: [protocol/tasks.ts:674](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L674)
