...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / TASK\_STATUSES

# Variable: TASK\_STATUSES

> `const` **TASK\_STATUSES**: readonly \[`"working"`, `"input_required"`, `"completed"`, `"failed"`, `"cancelled"`\]

Defined in: [protocol/tasks.ts:208](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L208)
