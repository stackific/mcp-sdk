...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / ELICITATION\_MODE

# Variable: ELICITATION\_MODE

> `const` **ELICITATION\_MODE**: `object`

Defined in: [protocol/elicitation.ts:70](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation.ts#L70)
