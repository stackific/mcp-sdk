...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildUiHostExtensionCapability

# Function: buildUiHostExtensionCapability()

> **buildUiHostExtensionCapability**(`additionalMimeTypes?`): `objectOutputType`

Defined in: [protocol/ui.ts:248](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L248)
