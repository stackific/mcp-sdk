...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildCallToolResult

# Function: buildCallToolResult()

> **buildCallToolResult**(`config`): `objectOutputType`

Defined in: [protocol/tools-call.ts:318](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools-call.ts#L318)
