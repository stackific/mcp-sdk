...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isSupportedProtocolVersion

# Function: isSupportedProtocolVersion()

> **isSupportedProtocolVersion**(`version`): `boolean`

Defined in: [protocol/meta.ts:143](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/meta.ts#L143)
