...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateIconBytes

# Function: validateIconBytes()

> **validateIconBytes**(`bytes`, `declaredMimeType?`, `allowedTypes?`): `string`

Defined in: [types/icon.ts:162](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/icon.ts#L162)
