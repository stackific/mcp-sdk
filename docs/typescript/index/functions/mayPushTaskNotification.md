...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayPushTaskNotification

# Function: mayPushTaskNotification()

> **mayPushTaskNotification**(`taskId`, `subscribedTaskIds`): `boolean`

Defined in: [protocol/tasks-lifecycle.ts:579](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L579)
