...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resourceParameterFor

# Function: resourceParameterFor()

> **resourceParameterFor**(`canonicalResourceIdentifier`): `string`

Defined in: [protocol/authorization-flow.ts:1425](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L1425)
