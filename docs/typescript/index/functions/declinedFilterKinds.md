...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / declinedFilterKinds

# Function: declinedFilterKinds()

> **declinedFilterKinds**(`requested`, `acknowledged`): `object`

Defined in: [protocol/streaming.ts:431](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/streaming.ts#L431)
