...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / errorCodeForInboundFailure

# Function: errorCodeForInboundFailure()

> **errorCodeForInboundFailure**(`stage`): `number`

Defined in: [protocol/errors.ts:601](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/errors.ts#L601)
