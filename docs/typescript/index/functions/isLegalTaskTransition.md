...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isLegalTaskTransition

# Function: isLegalTaskTransition()

> **isLegalTaskTransition**(`from`, `to`): `boolean`

Defined in: [protocol/tasks.ts:270](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L270)
