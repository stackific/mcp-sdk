...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / uiResourceReadUri

# Function: uiResourceReadUri()

> **uiResourceReadUri**(`meta`): `string` \| `undefined`

Defined in: [protocol/ui.ts:939](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L939)
