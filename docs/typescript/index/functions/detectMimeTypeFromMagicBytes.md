...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / detectMimeTypeFromMagicBytes

# Function: detectMimeTypeFromMagicBytes()

> **detectMimeTypeFromMagicBytes**(`bytes`): `string` \| `null`

Defined in: [types/icon.ts:129](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/icon.ts#L129)
