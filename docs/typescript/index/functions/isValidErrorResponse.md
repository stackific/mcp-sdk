...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidErrorResponse

# Function: isValidErrorResponse()

> **isValidErrorResponse**(`value`): `value is JsonRpcErrorResponse`

Defined in: [protocol/errors.ts:406](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/errors.ts#L406)
