...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateInputResponseKeys

# Function: validateInputResponseKeys()

> **validateInputResponseKeys**(`inputRequests`, `inputResponses`): `object`

Defined in: [protocol/multi-round-trip.ts:344](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/multi-round-trip.ts#L344)
