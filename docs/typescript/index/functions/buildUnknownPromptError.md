...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildUnknownPromptError

# Function: buildUnknownPromptError()

> **buildUnknownPromptError**(`name`): [`PromptsGetError`](../interfaces/PromptsGetError.md)

Defined in: [protocol/prompts.ts:580](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/prompts.ts#L580)
