...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidTracestate

# Function: isValidTracestate()

> **isValidTracestate**(`value`): `boolean`

Defined in: [json/meta-key.ts:173](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/json/meta-key.ts#L173)
