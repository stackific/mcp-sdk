...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateToolArguments

# Function: validateToolArguments()

> **validateToolArguments**(`tool`, `args`): [`SchemaValueValidation`](../interfaces/SchemaValueValidation.md)

Defined in: [protocol/tools.ts:491](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L491)
