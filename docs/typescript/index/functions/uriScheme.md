...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / uriScheme

# Function: uriScheme()

> **uriScheme**(`value`): `string` \| `undefined`

Defined in: [protocol/resources-read.ts:570](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources-read.ts#L570)
