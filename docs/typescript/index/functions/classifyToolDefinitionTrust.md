...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / classifyToolDefinitionTrust

# Function: classifyToolDefinitionTrust()

> **classifyToolDefinitionTrust**(`serverIsTrusted`): [`InputTrust`](../type-aliases/InputTrust.md)

Defined in: [protocol/security.ts:456](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/security.ts#L456)
