...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isPathWithinReportedRoots

# Function: isPathWithinReportedRoots()

> **isPathWithinReportedRoots**(`derivedUri`, `reportedRoots`): `boolean`

Defined in: [protocol/roots.ts:564](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/roots.ts#L564)
