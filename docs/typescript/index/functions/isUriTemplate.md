...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isUriTemplate

# Function: isUriTemplate()

> **isUriTemplate**(`value`): `value is string`

Defined in: [protocol/resources.ts:212](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources.ts#L212)
