...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / augmentClientCapabilities

# Function: augmentClientCapabilities()

> **augmentClientCapabilities**(`declared`, `requiredCapabilities`): `Record`\<`string`, `unknown`\>

Defined in: [protocol/negotiation.ts:189](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/negotiation.ts#L189)
