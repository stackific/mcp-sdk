...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildMethodNotFoundResponse

# Function: buildMethodNotFoundResponse()

> **buildMethodNotFoundResponse**(`method`, `id?`): [`HttpResponse`](../interfaces/HttpResponse.md)

Defined in: [transport/http/responses.ts:400](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L400)
