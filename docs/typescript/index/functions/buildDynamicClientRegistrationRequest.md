...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildDynamicClientRegistrationRequest

# ~~Function: buildDynamicClientRegistrationRequest()~~

> **buildDynamicClientRegistrationRequest**(`options`): `objectOutputType`

Defined in: [protocol/authorization-flow.ts:467](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L467)
