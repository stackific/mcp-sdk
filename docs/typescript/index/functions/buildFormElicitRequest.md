...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildFormElicitRequest

# Function: buildFormElicitRequest()

> **buildFormElicitRequest**(`opts`): `objectOutputType`

Defined in: [protocol/elicitation.ts:515](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation.ts#L515)
