...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isConfidentialToken

# Function: isConfidentialToken()

> **isConfidentialToken**(): `boolean`

Defined in: [protocol/authorization-registration.ts:1130](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L1130)
