...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isReservedMetaKey

# Function: isReservedMetaKey()

> **isReservedMetaKey**(`key`): `boolean`

Defined in: [protocol/registries.ts:372](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/registries.ts#L372)
