...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildPromptInternalError

# Function: buildPromptInternalError()

> **buildPromptInternalError**(`detail?`): [`PromptsGetError`](../interfaces/PromptsGetError.md)

Defined in: [protocol/prompts.ts:607](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/prompts.ts#L607)
