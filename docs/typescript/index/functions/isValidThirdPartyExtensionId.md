...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidThirdPartyExtensionId

# Function: isValidThirdPartyExtensionId()

> **isValidThirdPartyExtensionId**(`identifier`): `boolean`

Defined in: [protocol/extension-mechanism.ts:166](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extension-mechanism.ts#L166)
