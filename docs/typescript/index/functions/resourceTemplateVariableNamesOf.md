...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resourceTemplateVariableNamesOf

# Function: resourceTemplateVariableNamesOf()

> **resourceTemplateVariableNamesOf**(`template`, `extractVariables`): `string`[]

Defined in: [protocol/completion.ts:795](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L795)
