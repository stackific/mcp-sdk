...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / serverDeclaresResources

# Function: serverDeclaresResources()

> **serverDeclaresResources**(`serverCaps`): `boolean`

Defined in: [protocol/resources.ts:105](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources.ts#L105)
