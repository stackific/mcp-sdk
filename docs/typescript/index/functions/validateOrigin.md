...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateOrigin

# Function: validateOrigin()

> **validateOrigin**(`origin`, `acceptedOrigins`): \{ `accepted`: `true`; \} \| \{ `accepted`: `false`; `origin`: `string`; \}

Defined in: [transport/http/responses.ts:525](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L525)
