...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildSandboxReport

# Function: buildSandboxReport()

> **buildSandboxReport**(`effectiveCsp`, `granted`): `objectOutputType`

Defined in: [protocol/ui-host.ts:1073](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L1073)
