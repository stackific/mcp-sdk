...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveProtectedResourceMetadataUris

# Function: resolveProtectedResourceMetadataUris()

> **resolveProtectedResourceMetadataUris**(`options`): `string`[]

Defined in: [protocol/authorization.ts:710](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L710)
