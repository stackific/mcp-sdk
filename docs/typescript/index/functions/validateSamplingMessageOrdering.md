...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateSamplingMessageOrdering

# Function: validateSamplingMessageOrdering()

> **validateSamplingMessageOrdering**(`messages`): `object`

Defined in: [protocol/sampling.ts:690](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/sampling.ts#L690)
