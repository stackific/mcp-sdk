...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildTeardownResponse

# Function: buildTeardownResponse()

> **buildTeardownResponse**(`id`): `object`

Defined in: [protocol/ui-host.ts:1021](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L1021)
