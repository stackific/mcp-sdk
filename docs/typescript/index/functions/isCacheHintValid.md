...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isCacheHintValid

# Function: isCacheHintValid()

> **isCacheHintValid**(`ttlMs`, `cacheScope`): `boolean`

Defined in: [protocol/caching.ts:89](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/caching.ts#L89)
