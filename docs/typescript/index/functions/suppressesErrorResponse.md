...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / suppressesErrorResponse

# Function: suppressesErrorResponse()

> **suppressesErrorResponse**(`message`): `boolean`

Defined in: [protocol/errors.ts:438](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/errors.ts#L438)
