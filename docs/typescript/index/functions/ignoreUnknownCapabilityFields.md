...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / ignoreUnknownCapabilityFields

# Function: ignoreUnknownCapabilityFields()

> **ignoreUnknownCapabilityFields**(`caps`, `known`): `Record`\<`string`, `unknown`\>

Defined in: [protocol/extensions.ts:406](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L406)
