...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveCompleteResultType

# Function: resolveCompleteResultType()

> **resolveCompleteResultType**(`result`): `string`

Defined in: [protocol/completion.ts:433](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L433)
