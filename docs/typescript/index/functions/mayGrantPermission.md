...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayGrantPermission

# Function: mayGrantPermission()

> **mayGrantPermission**(`permissions`, `name`, `hostDeclines?`): `boolean`

Defined in: [protocol/ui.ts:739](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L739)
