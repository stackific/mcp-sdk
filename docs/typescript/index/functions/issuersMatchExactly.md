...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / issuersMatchExactly

# Function: issuersMatchExactly()

> **issuersMatchExactly**(`a`, `b`): `boolean`

Defined in: [protocol/authorization-registration.ts:505](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L505)
