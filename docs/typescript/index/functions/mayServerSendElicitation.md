...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayServerSendElicitation

# Function: mayServerSendElicitation()

> **mayServerSendElicitation**(`clientCaps`, `mode?`): `boolean`

Defined in: [protocol/elicitation.ts:496](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation.ts#L496)
