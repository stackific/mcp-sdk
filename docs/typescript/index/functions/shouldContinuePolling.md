...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / shouldContinuePolling

# Function: shouldContinuePolling()

> **shouldContinuePolling**(`status`, `cancelRequested?`): `boolean`

Defined in: [protocol/tasks-lifecycle.ts:702](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L702)
