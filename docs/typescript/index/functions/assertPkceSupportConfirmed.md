...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / assertPkceSupportConfirmed

# Function: assertPkceSupportConfirmed()

> **assertPkceSupportConfirmed**(`metadata`): `void`

Defined in: [protocol/authorization-flow.ts:838](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L838)
