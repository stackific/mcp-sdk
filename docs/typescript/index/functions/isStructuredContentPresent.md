...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isStructuredContentPresent

# Function: isStructuredContentPresent()

> **isStructuredContentPresent**(`result`): `boolean`

Defined in: [protocol/tools-call.ts:274](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools-call.ts#L274)
