...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / numericEqual

# Function: numericEqual()

> **numericEqual**(`a`, `b`): `boolean`

Defined in: [json/value.ts:77](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/json/value.ts#L77)
