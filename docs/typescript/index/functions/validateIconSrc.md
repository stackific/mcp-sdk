...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateIconSrc

# Function: validateIconSrc()

> **validateIconSrc**(`src`): `void`

Defined in: [types/icon.ts:91](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/icon.ts#L91)
