...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / deriveExtensionNamespace

# Function: deriveExtensionNamespace()

> **deriveExtensionNamespace**(`identifier`): `string` \| `undefined`

Defined in: [protocol/extension-mechanism.ts:251](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extension-mechanism.ts#L251)
