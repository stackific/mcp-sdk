...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / suggestSuccessorIdentifier

# Function: suggestSuccessorIdentifier()

> **suggestSuccessorIdentifier**(`identifier`, `suffix?`): `string`

Defined in: [protocol/extension-mechanism.ts:533](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extension-mechanism.ts#L533)
