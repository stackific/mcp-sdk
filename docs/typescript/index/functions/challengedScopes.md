...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / challengedScopes

# Function: challengedScopes()

> **challengedScopes**(`challenge`): `string`[]

Defined in: [protocol/authorization.ts:555](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L555)
