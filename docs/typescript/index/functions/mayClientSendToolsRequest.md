...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayClientSendToolsRequest

# Function: mayClientSendToolsRequest()

> **mayClientSendToolsRequest**(`serverCaps`, `method?`): `boolean`

Defined in: [protocol/tools.ts:124](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L124)
