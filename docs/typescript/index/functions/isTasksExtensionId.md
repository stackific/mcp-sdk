...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isTasksExtensionId

# Function: isTasksExtensionId()

> **isTasksExtensionId**(`identifier`): `boolean`

Defined in: [protocol/tasks.ts:77](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L77)
