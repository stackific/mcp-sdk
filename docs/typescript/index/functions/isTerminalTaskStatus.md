...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isTerminalTaskStatus

# Function: isTerminalTaskStatus()

> **isTerminalTaskStatus**(`status`): `boolean`

Defined in: [protocol/tasks.ts:246](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L246)
