...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / fetchIcon

# Function: fetchIcon()

> **fetchIcon**(`src`, `options?`): `Promise`\<[`FetchIconResult`](../interfaces/FetchIconResult.md)\>

Defined in: [types/icon.ts:251](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/icon.ts#L251)
