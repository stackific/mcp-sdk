...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / selectTokenForServer

# Function: selectTokenForServer()

> **selectTokenForServer**(`options`): [`TokenSelectionResult`](../type-aliases/TokenSelectionResult.md)

Defined in: [protocol/authorization-flow.ts:1481](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L1481)
