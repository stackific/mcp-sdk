...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveDisplayName

# Function: resolveDisplayName()

> **resolveDisplayName**(`name`, `title?`, `annotationsTitle?`): `string`

Defined in: [types/base-metadata.ts:41](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/base-metadata.ts#L41)
