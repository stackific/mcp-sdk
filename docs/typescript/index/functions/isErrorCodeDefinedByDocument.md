...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isErrorCodeDefinedByDocument

# Function: isErrorCodeDefinedByDocument()

> **isErrorCodeDefinedByDocument**(`code`): `boolean`

Defined in: [protocol/registries.ts:858](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/registries.ts#L858)
