...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / encodeMessageUnit

# Function: encodeMessageUnit()

> **encodeMessageUnit**(`message`): `Uint8Array`

Defined in: [transport/framing.ts:44](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/framing.ts#L44)
