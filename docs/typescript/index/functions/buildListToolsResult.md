...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildListToolsResult

# Function: buildListToolsResult()

> **buildListToolsResult**(`config`): `objectOutputType`

Defined in: [protocol/tools.ts:741](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L741)
