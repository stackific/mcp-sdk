...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildListResourcesResult

# Function: buildListResourcesResult()

> **buildListResourcesResult**(`resources`, `hints`, `opts?`): `object` & `object` & `object` & `object`

Defined in: [protocol/resources.ts:539](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources.ts#L539)
