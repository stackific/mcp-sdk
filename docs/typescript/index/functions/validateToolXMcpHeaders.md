...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateToolXMcpHeaders

# Function: validateToolXMcpHeaders()

> **validateToolXMcpHeaders**(`tool`): [`ToolValidationResult`](../type-aliases/ToolValidationResult.md)

Defined in: [transport/http/param-headers.ts:143](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/param-headers.ts#L143)
