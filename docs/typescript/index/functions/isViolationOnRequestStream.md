...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isViolationOnRequestStream

# Function: isViolationOnRequestStream()

> **isViolationOnRequestStream**(`method`): `boolean`

Defined in: [protocol/streaming.ts:562](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/streaming.ts#L562)
