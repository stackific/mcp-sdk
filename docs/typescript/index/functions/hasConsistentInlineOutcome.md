...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / hasConsistentInlineOutcome

# Function: hasConsistentInlineOutcome()

> **hasConsistentInlineOutcome**(`task`): `boolean`

Defined in: [protocol/tasks.ts:543](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L543)
