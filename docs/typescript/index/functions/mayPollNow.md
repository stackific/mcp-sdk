...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayPollNow

# Function: mayPollNow()

> **mayPollNow**(`lastPolledAtMs`, `nowMs`, `pollIntervalMs`, `fallbackMs?`): `boolean`

Defined in: [protocol/tasks.ts:621](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L621)
