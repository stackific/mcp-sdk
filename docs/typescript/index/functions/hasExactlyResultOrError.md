...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / hasExactlyResultOrError

# Function: hasExactlyResultOrError()

> **hasExactlyResultOrError**(`response`): `boolean`

Defined in: [protocol/errors.ts:388](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/errors.ts#L388)
