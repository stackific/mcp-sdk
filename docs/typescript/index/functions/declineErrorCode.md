...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / declineErrorCode

# Function: declineErrorCode()

> **declineErrorCode**(`reason`): `number`

Defined in: [protocol/ui-host.ts:861](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L861)
