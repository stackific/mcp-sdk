...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildBearerAuthorizationHeader

# Function: buildBearerAuthorizationHeader()

> **buildBearerAuthorizationHeader**(`accessToken`): `string`

Defined in: [protocol/authorization-flow.ts:1510](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L1510)
