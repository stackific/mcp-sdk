...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / tryDecodeMessageUnit

# Function: tryDecodeMessageUnit()

> **tryDecodeMessageUnit**(`bytes`): [`DecodeResult`](../type-aliases/DecodeResult.md)

Defined in: [transport/framing.ts:108](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/framing.ts#L108)
