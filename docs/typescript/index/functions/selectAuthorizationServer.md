...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / selectAuthorizationServer

# Function: selectAuthorizationServer()

> **selectAuthorizationServer**(`metadata`, `prefer?`): `string` \| `undefined`

Defined in: [protocol/authorization.ts:650](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L650)
