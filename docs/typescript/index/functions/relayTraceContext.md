...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / relayTraceContext

# Function: relayTraceContext()

> **relayTraceContext**(`inbound`, `outbound`): `Record`\<`string`, `unknown`\>

Defined in: [protocol/logging.ts:239](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/logging.ts#L239)
