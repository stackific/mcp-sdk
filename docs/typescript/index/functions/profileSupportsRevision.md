...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / profileSupportsRevision

# Function: profileSupportsRevision()

> **profileSupportsRevision**(`profile`, `revision`): `boolean`

Defined in: [protocol/conformance-requirements.ts:915](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/conformance-requirements.ts#L915)
