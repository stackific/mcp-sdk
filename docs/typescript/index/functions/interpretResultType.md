...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / interpretResultType

# Function: interpretResultType()

> **interpretResultType**(`result`): [`ResultTypeInterpretation`](../type-aliases/ResultTypeInterpretation.md)

Defined in: [jsonrpc/payload.ts:72](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/jsonrpc/payload.ts#L72)
