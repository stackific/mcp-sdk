...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / protectedResourceWellKnownUris

# Function: protectedResourceWellKnownUris()

> **protectedResourceWellKnownUris**(`endpointUrl`): `string`[]

Defined in: [protocol/authorization.ts:682](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L682)
