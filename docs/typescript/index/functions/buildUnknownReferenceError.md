...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildUnknownReferenceError

# Function: buildUnknownReferenceError()

> **buildUnknownReferenceError**(`detail`): [`CompletionError`](../interfaces/CompletionError.md)

Defined in: [protocol/completion.ts:614](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L614)
