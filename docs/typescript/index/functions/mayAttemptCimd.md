...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayAttemptCimd

# Function: mayAttemptCimd()

> **mayAttemptCimd**(`metadata`): `boolean`

Defined in: [protocol/authorization-registration.ts:193](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L193)
