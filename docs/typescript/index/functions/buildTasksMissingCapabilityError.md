...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildTasksMissingCapabilityError

# Function: buildTasksMissingCapabilityError()

> **buildTasksMissingCapabilityError**(`method`): `object`

Defined in: [protocol/tasks.ts:651](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L651)
