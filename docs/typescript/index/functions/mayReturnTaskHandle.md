...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayReturnTaskHandle

# Function: mayReturnTaskHandle()

> **mayReturnTaskHandle**(`requestClientExtensions`, `serverExtensions`): `boolean`

Defined in: [protocol/tasks.ts:189](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L189)
