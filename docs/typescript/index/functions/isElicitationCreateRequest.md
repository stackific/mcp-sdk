...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isElicitationCreateRequest

# Function: isElicitationCreateRequest()

> **isElicitationCreateRequest**(`value`): `boolean`

Defined in: [protocol/elicitation.ts:257](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation.ts#L257)
