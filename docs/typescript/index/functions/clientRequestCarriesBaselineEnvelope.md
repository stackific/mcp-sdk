...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / clientRequestCarriesBaselineEnvelope

# Function: clientRequestCarriesBaselineEnvelope()

> **clientRequestCarriesBaselineEnvelope**(`meta`): `boolean`

Defined in: [protocol/conformance-requirements.ts:567](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/conformance-requirements.ts#L567)
