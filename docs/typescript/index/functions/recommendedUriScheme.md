...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / recommendedUriScheme

# Function: recommendedUriScheme()

> **recommendedUriScheme**(`directlyFetchable`): `object`

Defined in: [protocol/resources-read.ts:620](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources-read.ts#L620)
