...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isMetaKeyPermitted

# Function: isMetaKeyPermitted()

> **isMetaKeyPermitted**(`key`): `boolean`

Defined in: [protocol/registries.ts:390](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/registries.ts#L390)
