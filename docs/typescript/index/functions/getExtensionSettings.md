...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / getExtensionSettings

# Function: getExtensionSettings()

> **getExtensionSettings**(`raw`, `identifier`): `Record`\<`string`, `unknown`\> \| `undefined`

Defined in: [protocol/extensions.ts:243](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L243)
