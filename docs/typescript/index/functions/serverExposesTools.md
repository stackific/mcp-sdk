...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / serverExposesTools

# Function: serverExposesTools()

> **serverExposesTools**(`serverCaps`): `boolean`

Defined in: [protocol/tools.ts:96](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L96)
