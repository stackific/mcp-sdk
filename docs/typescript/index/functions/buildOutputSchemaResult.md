...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildOutputSchemaResult

# Function: buildOutputSchemaResult()

> **buildOutputSchemaResult**(`structuredContent`, `extraContent?`): `objectOutputType`

Defined in: [protocol/tools-call.ts:343](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools-call.ts#L343)
