...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayCallCompletion

# Function: mayCallCompletion()

> **mayCallCompletion**(`serverCaps`): `boolean`

Defined in: [protocol/completion.ts:160](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L160)
