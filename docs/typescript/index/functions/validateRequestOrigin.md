...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateRequestOrigin

# Function: validateRequestOrigin()

> **validateRequestOrigin**(`origin`, `acceptedOrigins`): \{ `accepted`: `true`; \} \| \{ `accepted`: `false`; `origin`: `string`; \}

Defined in: [protocol/security.ts:1422](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/security.ts#L1422)
