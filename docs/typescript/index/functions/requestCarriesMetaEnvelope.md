...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / requestCarriesMetaEnvelope

# Function: requestCarriesMetaEnvelope()

> **requestCarriesMetaEnvelope**(`request`): `boolean`

Defined in: [transport/contract.ts:183](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L183)
