...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateToolResultReferences

# Function: validateToolResultReferences()

> **validateToolResultReferences**(`messages`): `object`

Defined in: [protocol/sampling.ts:769](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/sampling.ts#L769)
