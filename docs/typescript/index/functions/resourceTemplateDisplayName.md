...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resourceTemplateDisplayName

# Function: resourceTemplateDisplayName()

> **resourceTemplateDisplayName**(`template`): `string`

Defined in: [protocol/resources.ts:411](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources.ts#L411)
