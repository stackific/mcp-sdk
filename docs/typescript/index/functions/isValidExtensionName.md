...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidExtensionName

# Function: isValidExtensionName()

> **isValidExtensionName**(`name`): `boolean`

Defined in: [protocol/extensions.ts:69](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L69)
