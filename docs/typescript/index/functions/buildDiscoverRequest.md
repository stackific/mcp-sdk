...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildDiscoverRequest

# Function: buildDiscoverRequest()

> **buildDiscoverRequest**(`id`, `protocolVersion`, `clientInfo`, `clientCapabilities`, `extraMeta?`): `object`

Defined in: [protocol/discovery.ts:389](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/discovery.ts#L389)
