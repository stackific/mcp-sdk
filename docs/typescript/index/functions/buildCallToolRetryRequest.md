...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildCallToolRetryRequest

# Function: buildCallToolRetryRequest()

> **buildCallToolRetryRequest**(`initialId`, `retryId`, `config`): `objectOutputType`

Defined in: [protocol/tools-call.ts:191](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools-call.ts#L191)
