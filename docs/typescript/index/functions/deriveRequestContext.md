...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / deriveRequestContext

# Function: deriveRequestContext()

> **deriveRequestContext**(`request`): [`RequestContext`](../interfaces/RequestContext.md) \| `undefined`

Defined in: [transport/contract.ts:199](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/contract.ts#L199)
