...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isTasksExtensionCapability

# Function: isTasksExtensionCapability()

> **isTasksExtensionCapability**(`value`): `value is Record<string, unknown>`

Defined in: [protocol/tasks.ts:123](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L123)
