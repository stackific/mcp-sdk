...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidCimdClientIdUrl

# Function: isValidCimdClientIdUrl()

> **isValidCimdClientIdUrl**(`clientId`): `boolean`

Defined in: [protocol/authorization-flow.ts:322](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L322)
