...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / prefixMatch

# Function: prefixMatch()

> **prefixMatch**(`seed`, `candidates`, `opts?`): `string`[]

Defined in: [protocol/completion.ts:550](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L550)
