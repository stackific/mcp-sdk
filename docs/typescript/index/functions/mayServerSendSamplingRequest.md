...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayServerSendSamplingRequest

# Function: mayServerSendSamplingRequest()

> **mayServerSendSamplingRequest**(`clientCaps`, `params`): `boolean`

Defined in: [protocol/sampling.ts:588](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/sampling.ts#L588)
