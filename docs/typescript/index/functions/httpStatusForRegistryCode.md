...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / httpStatusForRegistryCode

# Function: httpStatusForRegistryCode()

> **httpStatusForRegistryCode**(`code`): `number` \| `undefined`

Defined in: [protocol/errors.ts:573](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/errors.ts#L573)
