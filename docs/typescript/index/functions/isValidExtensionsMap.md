...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidExtensionsMap

# Function: isValidExtensionsMap()

> **isValidExtensionsMap**(`map`): `map is Record<string, Record<string, unknown>>`

Defined in: [protocol/extensions.ts:183](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L183)
