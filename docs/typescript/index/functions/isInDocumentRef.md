...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isInDocumentRef

# Function: isInDocumentRef()

> **isInDocumentRef**(`ref`): `boolean`

Defined in: [protocol/tools.ts:193](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L193)
