...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildTaskStatusNotification

# Function: buildTaskStatusNotification()

> **buildTaskStatusNotification**(`task`): `objectOutputType`

Defined in: [protocol/tasks-lifecycle.ts:528](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L528)
