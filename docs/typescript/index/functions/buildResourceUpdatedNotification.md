...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildResourceUpdatedNotification

# Function: buildResourceUpdatedNotification()

> **buildResourceUpdatedNotification**(`uri`, `subscriptionId`, `extraMeta?`): `objectOutputType`

Defined in: [protocol/resources-read.ts:470](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources-read.ts#L470)
