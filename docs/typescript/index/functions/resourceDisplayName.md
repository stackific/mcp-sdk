...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resourceDisplayName

# Function: resourceDisplayName()

> **resourceDisplayName**(`resource`): `string`

Defined in: [protocol/resources.ts:354](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources.ts#L354)
