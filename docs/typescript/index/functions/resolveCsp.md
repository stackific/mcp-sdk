...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveCsp

# Function: resolveCsp()

> **resolveCsp**(`csp`): `objectOutputType`

Defined in: [protocol/ui.ts:664](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L664)
