...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / protectedResourceMetadataUris

# Function: protectedResourceMetadataUris()

> **protectedResourceMetadataUris**(`options`): `string`[]

Defined in: [protocol/authorization-registration.ts:637](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L637)
