...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / createPkceChallenge

# Function: createPkceChallenge()

> **createPkceChallenge**(`randomSource?`): [`PkceChallenge`](../interfaces/PkceChallenge.md)

Defined in: [protocol/authorization-flow.ts:183](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L183)
