...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildTaskUnknownError

# Function: buildTaskUnknownError()

> **buildTaskUnknownError**(`taskId`, `operation?`): `object`

Defined in: [protocol/tasks-lifecycle.ts:129](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L129)
