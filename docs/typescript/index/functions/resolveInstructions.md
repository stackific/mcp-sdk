...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveInstructions

# Function: resolveInstructions()

> **resolveInstructions**(`result`): `string` \| `undefined`

Defined in: [protocol/discovery.ts:463](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/discovery.ts#L463)
