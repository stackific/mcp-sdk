...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / satisfiesRole

# Function: satisfiesRole()

> **satisfiesRole**(`satisfiedRoles`, `targetRole`): `boolean`

Defined in: [protocol/conformance-requirements.ts:972](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/conformance-requirements.ts#L972)
