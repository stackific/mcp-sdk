...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidMetaKeyName

# Function: isValidMetaKeyName()

> **isValidMetaKeyName**(`name`): `boolean`

Defined in: [json/meta-key.ts:67](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/json/meta-key.ts#L67)
