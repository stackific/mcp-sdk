...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isPollingTerminalResponse

# Function: isPollingTerminalResponse()

> **isPollingTerminalResponse**(`response`): `boolean`

Defined in: [protocol/tasks-lifecycle.ts:716](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L716)
