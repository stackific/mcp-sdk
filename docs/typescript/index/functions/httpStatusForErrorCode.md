...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / httpStatusForErrorCode

# Function: httpStatusForErrorCode()

> **httpStatusForErrorCode**(`code`): `400` \| `404`

Defined in: [transport/http/responses.ts:427](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L427)
