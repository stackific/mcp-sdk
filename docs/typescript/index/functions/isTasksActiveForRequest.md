...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isTasksActiveForRequest

# Function: isTasksActiveForRequest()

> **isTasksActiveForRequest**(`requestClientExtensions`, `serverExtensions`): `boolean`

Defined in: [protocol/tasks.ts:167](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L167)
