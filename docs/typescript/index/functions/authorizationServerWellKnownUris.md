...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / authorizationServerWellKnownUris

# Function: authorizationServerWellKnownUris()

> **authorizationServerWellKnownUris**(`issuer`): `string`[]

Defined in: [protocol/authorization.ts:858](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L858)
