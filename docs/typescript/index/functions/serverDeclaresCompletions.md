...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / serverDeclaresCompletions

# Function: serverDeclaresCompletions()

> **serverDeclaresCompletions**(`serverCaps`): `boolean`

Defined in: [protocol/completion.ts:148](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L148)
