...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isTaskExpired

# Function: isTaskExpired()

> **isTaskExpired**(`createdAtMs`, `ttlMs`, `nowMs`): `boolean`

Defined in: [protocol/tasks.ts:576](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L576)
