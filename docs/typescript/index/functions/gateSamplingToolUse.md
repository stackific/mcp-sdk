...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / gateSamplingToolUse

# Function: gateSamplingToolUse()

> **gateSamplingToolUse**(`clientCaps`, `params`): [`SamplingGateResult`](../type-aliases/SamplingGateResult.md)

Defined in: [protocol/sampling.ts:569](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/sampling.ts#L569)
