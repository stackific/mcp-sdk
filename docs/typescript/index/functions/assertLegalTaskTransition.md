...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / assertLegalTaskTransition

# Function: assertLegalTaskTransition()

> **assertLegalTaskTransition**(`from`, `to`): `void`

Defined in: [protocol/tasks.ts:295](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L295)
