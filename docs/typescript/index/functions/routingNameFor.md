...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / routingNameFor

# Function: routingNameFor()

> **routingNameFor**(`method`, `params`): `string` \| `undefined`

Defined in: [transport/http/headers.ts:119](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/headers.ts#L119)
