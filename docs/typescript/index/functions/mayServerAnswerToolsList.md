...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayServerAnswerToolsList

# Function: mayServerAnswerToolsList()

> **mayServerAnswerToolsList**(`serverCaps`, `method?`): `boolean`

Defined in: [protocol/tools.ts:108](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L108)
