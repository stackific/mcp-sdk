...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isAbsoluteUri

# Function: isAbsoluteUri()

> **isAbsoluteUri**(`value`): `value is string`

Defined in: [protocol/streaming.ts:136](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/streaming.ts#L136)
