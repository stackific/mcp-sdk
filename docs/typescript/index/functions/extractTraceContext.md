...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / extractTraceContext

# Function: extractTraceContext()

> **extractTraceContext**(`meta`): `Partial`\<`Record`\<[`TraceContextKey`](../type-aliases/TraceContextKey.md), `string`\>\>

Defined in: [protocol/logging.ts:259](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/logging.ts#L259)
