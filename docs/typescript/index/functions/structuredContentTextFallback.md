...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / structuredContentTextFallback

# Function: structuredContentTextFallback()

> **structuredContentTextFallback**(`structuredContent`): `objectOutputType`

Defined in: [protocol/tools-call.ts:288](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools-call.ts#L288)
