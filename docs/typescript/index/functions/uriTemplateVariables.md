...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / uriTemplateVariables

# Function: uriTemplateVariables()

> **uriTemplateVariables**(`template`): `string`[]

Defined in: [protocol/resources.ts:283](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources.ts#L283)
