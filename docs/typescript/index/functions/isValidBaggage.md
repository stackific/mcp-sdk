...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidBaggage

# Function: isValidBaggage()

> **isValidBaggage**(`value`): `boolean`

Defined in: [json/meta-key.ts:227](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/json/meta-key.ts#L227)
