...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildRefreshTokenRequest

# Function: buildRefreshTokenRequest()

> **buildRefreshTokenRequest**(`options`): [`RefreshTokenRequest`](../interfaces/RefreshTokenRequest.md)

Defined in: [protocol/authorization-flow.ts:1292](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L1292)
