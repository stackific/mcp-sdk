...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildCompletionInternalError

# Function: buildCompletionInternalError()

> **buildCompletionInternalError**(`detail?`): [`CompletionError`](../interfaces/CompletionError.md)

Defined in: [protocol/completion.ts:628](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L628)
