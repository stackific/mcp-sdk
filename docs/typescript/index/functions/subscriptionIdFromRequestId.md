...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / subscriptionIdFromRequestId

# Function: subscriptionIdFromRequestId()

> **subscriptionIdFromRequestId**(`id`): `string`

Defined in: [protocol/streaming.ts:120](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/streaming.ts#L120)
