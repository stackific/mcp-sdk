...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / sameRequestRecord

# Function: sameRequestRecord()

> **sameRequestRecord**(`record`): [`RequestRecordValidation`](../type-aliases/RequestRecordValidation.md)

Defined in: [protocol/authorization-registration.ts:1105](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L1105)
