...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveHasMore

# Function: resolveHasMore()

> **resolveHasMore**(`completion`): `boolean`

Defined in: [protocol/completion.ts:444](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L444)
