...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / clientDeclaresTasksForRequest

# Function: clientDeclaresTasksForRequest()

> **clientDeclaresTasksForRequest**(`requestClientExtensions`): `boolean`

Defined in: [protocol/tasks.ts:139](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L139)
