...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isConventionalToolName

# Function: isConventionalToolName()

> **isConventionalToolName**(`name`): `boolean`

Defined in: [protocol/tools.ts:527](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L527)
