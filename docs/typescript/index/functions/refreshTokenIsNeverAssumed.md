...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / refreshTokenIsNeverAssumed

# Function: refreshTokenIsNeverAssumed()

> **refreshTokenIsNeverAssumed**(): `boolean`

Defined in: [protocol/authorization-registration.ts:1233](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L1233)
