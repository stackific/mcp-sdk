...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildDiscoverResult

# Function: buildDiscoverResult()

> **buildDiscoverResult**(`config`): `objectOutputType`

Defined in: [protocol/discovery.ts:248](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/discovery.ts#L248)
