...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / effectiveCacheScope

# Function: effectiveCacheScope()

> **effectiveCacheScope**(`scopes`): `"public"` \| `"private"`

Defined in: [protocol/caching.ts:177](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/caching.ts#L177)
