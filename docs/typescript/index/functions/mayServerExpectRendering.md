...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayServerExpectRendering

# Function: mayServerExpectRendering()

> **mayServerExpectRendering**(`hostExtensionsMap`): `boolean`

Defined in: [protocol/ui.ts:337](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L337)
