...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / sandboxIsolationIsConforming

# Function: sandboxIsolationIsConforming()

> **sandboxIsolationIsConforming**(`deniedAccess`): `boolean`

Defined in: [protocol/ui-host.ts:1155](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L1155)
