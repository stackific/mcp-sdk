...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildInputRequiredResult

# Function: buildInputRequiredResult()

> **buildInputRequiredResult**(`inputRequests?`, `requestState?`): `objectOutputType`

Defined in: [protocol/multi-round-trip.ts:165](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/multi-round-trip.ts#L165)
