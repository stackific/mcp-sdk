...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildParamHeaders

# Function: buildParamHeaders()

> **buildParamHeaders**(`inputSchema`, `args`): `Record`\<`string`, `string`\>

Defined in: [transport/http/param-headers.ts:222](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/param-headers.ts#L222)
