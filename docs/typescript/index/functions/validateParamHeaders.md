...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateParamHeaders

# Function: validateParamHeaders()

> **validateParamHeaders**(`inputSchema`, `args`, `headers`): [`HttpValidation`](../type-aliases/HttpValidation.md)

Defined in: [transport/http/param-headers.ts:281](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/param-headers.ts#L281)
