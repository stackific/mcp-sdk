...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / filterValidTools

# Function: filterValidTools()

> **filterValidTools**(`tools`): [`FilterToolsResult`](../interfaces/FilterToolsResult.md)

Defined in: [transport/http/param-headers.ts:190](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/param-headers.ts#L190)
