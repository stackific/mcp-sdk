...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / decideRequestStateHandling

# Function: decideRequestStateHandling()

> **decideRequestStateHandling**(`securitySignificant`, `integrityVerified`): `object`

Defined in: [protocol/conformance-requirements.ts:760](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/conformance-requirements.ts#L760)
