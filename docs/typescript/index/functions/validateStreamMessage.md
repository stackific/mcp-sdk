...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateStreamMessage

# Function: validateStreamMessage()

> **validateStreamMessage**(`message`): \{ `ok`: `true`; \} \| \{ `ok`: `false`; `reason`: `string`; \}

Defined in: [transport/http/responses.ts:206](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L206)
