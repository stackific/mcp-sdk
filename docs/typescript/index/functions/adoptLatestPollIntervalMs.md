...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / adoptLatestPollIntervalMs

# Function: adoptLatestPollIntervalMs()

> **adoptLatestPollIntervalMs**(`latestObserved`, `previousObserved`, `fallbackMs?`): `number`

Defined in: [protocol/tasks-lifecycle.ts:658](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L658)
