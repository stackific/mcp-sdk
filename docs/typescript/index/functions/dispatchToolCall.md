...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / dispatchToolCall

# Function: dispatchToolCall()

> **dispatchToolCall**(`params`, `exposedTools`): [`ToolDispatch`](../type-aliases/ToolDispatch.md)

Defined in: [protocol/tools-call.ts:469](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools-call.ts#L469)
