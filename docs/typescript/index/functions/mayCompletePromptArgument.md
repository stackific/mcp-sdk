...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayCompletePromptArgument

# Function: mayCompletePromptArgument()

> **mayCompletePromptArgument**(): `boolean`

Defined in: [protocol/prompts.ts:745](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/prompts.ts#L745)
