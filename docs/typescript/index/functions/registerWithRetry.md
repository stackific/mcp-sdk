...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / registerWithRetry

# Function: registerWithRetry()

> **registerWithRetry**(`options`): `Promise`\<[`DcrRetryResult`](../interfaces/DcrRetryResult.md)\>

Defined in: [protocol/authorization-registration.ts:440](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L440)
