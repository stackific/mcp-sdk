...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / normalizeExtensionsMap

# Function: normalizeExtensionsMap()

> **normalizeExtensionsMap**(`raw`): [`ExtensionsMap`](../type-aliases/ExtensionsMap.md)

Defined in: [protocol/extensions.ts:210](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L210)
