...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildTaskNotFoundError

# Function: buildTaskNotFoundError()

> **buildTaskNotFoundError**(`taskId`): `object`

Defined in: [protocol/tasks.ts:683](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L683)
