...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / sanitizeConsumedMetadata

# Function: sanitizeConsumedMetadata()

> **sanitizeConsumedMetadata**(`metadata`, `known`): `Record`\<`string`, `unknown`\>

Defined in: [protocol/security.ts:1277](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/security.ts#L1277)
