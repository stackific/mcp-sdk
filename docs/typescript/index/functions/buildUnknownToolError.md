...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildUnknownToolError

# Function: buildUnknownToolError()

> **buildUnknownToolError**(`name`): [`ToolProtocolError`](../interfaces/ToolProtocolError.md)

Defined in: [protocol/tools-call.ts:403](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools-call.ts#L403)
