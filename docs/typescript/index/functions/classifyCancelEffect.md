...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / classifyCancelEffect

# Function: classifyCancelEffect()

> **classifyCancelEffect**(`currentStatus`): `"acknowledged-terminal"` \| `"acknowledged-pending"`

Defined in: [protocol/tasks-lifecycle.ts:473](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L473)
