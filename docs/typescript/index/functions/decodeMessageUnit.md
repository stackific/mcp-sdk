...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / decodeMessageUnit

# Function: decodeMessageUnit()

> **decodeMessageUnit**(`bytes`): [`JSONRPCMessage`](../type-aliases/JSONRPCMessage.md)

Defined in: [transport/framing.ts:70](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/framing.ts#L70)
