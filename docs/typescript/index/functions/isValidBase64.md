...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidBase64

# Function: isValidBase64()

> **isValidBase64**(`s`): `boolean`

Defined in: [types/resource-contents.ts:19](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/resource-contents.ts#L19)
