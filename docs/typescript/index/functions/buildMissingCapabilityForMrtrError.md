...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildMissingCapabilityForMrtrError

# Function: buildMissingCapabilityForMrtrError()

> **buildMissingCapabilityForMrtrError**(`requiredCapabilities`): `object`

Defined in: [protocol/multi-round-trip.ts:318](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/multi-round-trip.ts#L318)
