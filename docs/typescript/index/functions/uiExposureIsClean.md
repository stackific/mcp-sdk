...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / uiExposureIsClean

# Function: uiExposureIsClean()

> **uiExposureIsClean**(`exposed`): `boolean`

Defined in: [protocol/ui-host.ts:1126](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L1126)
