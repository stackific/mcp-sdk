...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isIncompatibleChange

# Function: isIncompatibleChange()

> **isIncompatibleChange**(`kind`): `boolean`

Defined in: [protocol/extension-mechanism.ts:509](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extension-mechanism.ts#L509)
