...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isKnownContentBlockType

# Function: isKnownContentBlockType()

> **isKnownContentBlockType**(`type`): type is "resource" \| "text" \| "image" \| "audio" \| "resource\_link"

Defined in: [types/content.ts:150](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/types/content.ts#L150)
