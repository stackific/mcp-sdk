...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildAcceptResult

# Function: buildAcceptResult()

> **buildAcceptResult**(`opts`): `objectOutputType`

Defined in: [protocol/elicitation-form.ts:976](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation-form.ts#L976)
