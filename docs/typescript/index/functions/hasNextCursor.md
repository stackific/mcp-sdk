...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / hasNextCursor

# Function: hasNextCursor()

> **hasNextCursor**(`result`): `boolean`

Defined in: [protocol/pagination.ts:88](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/pagination.ts#L88)
