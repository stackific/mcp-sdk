...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / planStepUpAuthorization

# Function: planStepUpAuthorization()

> **planStepUpAuthorization**(`options`): [`StepUpPlan`](../interfaces/StepUpPlan.md)

Defined in: [protocol/authorization-registration.ts:962](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L962)
