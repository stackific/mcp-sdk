...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isPathTraversalSafe

# Function: isPathTraversalSafe()

> **isPathTraversalSafe**(`uri`): `boolean`

Defined in: [protocol/roots.ts:302](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/roots.ts#L302)
