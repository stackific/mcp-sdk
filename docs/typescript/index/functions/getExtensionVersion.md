...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / getExtensionVersion

# Function: getExtensionVersion()

> **getExtensionVersion**(`extensionsMap`, `identifier`, `versionKey?`): `string` \| `undefined`

Defined in: [protocol/extension-mechanism.ts:469](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extension-mechanism.ts#L469)
