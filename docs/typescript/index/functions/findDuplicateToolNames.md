...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / findDuplicateToolNames

# Function: findDuplicateToolNames()

> **findDuplicateToolNames**(`tools`): `string`[]

Defined in: [protocol/tools.ts:616](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L616)
