...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / selectRevision

# Function: selectRevision()

> **selectRevision**(`supportedVersions`, `clientAcceptable?`): `string` \| `undefined`

Defined in: [protocol/discovery.ts:443](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/discovery.ts#L443)
