...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / evaluateConsent

# Function: evaluateConsent()

> **evaluateConsent**(`request`, `priorGrant?`): [`ConsentDecision`](../type-aliases/ConsentDecision.md)

Defined in: [protocol/security.ts:373](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/security.ts#L373)
