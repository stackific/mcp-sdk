...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveElicitationMode

# Function: resolveElicitationMode()

> **resolveElicitationMode**(`params`): [`ElicitationMode`](../type-aliases/ElicitationMode.md) \| `undefined`

Defined in: [protocol/elicitation.ts:273](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation.ts#L273)
