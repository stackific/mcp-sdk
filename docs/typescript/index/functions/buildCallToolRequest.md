...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildCallToolRequest

# Function: buildCallToolRequest()

> **buildCallToolRequest**(`id`, `config`): `objectOutputType`

Defined in: [protocol/tools-call.ts:149](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools-call.ts#L149)
