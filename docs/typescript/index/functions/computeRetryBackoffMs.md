...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / computeRetryBackoffMs

# Function: computeRetryBackoffMs()

> **computeRetryBackoffMs**(`attempt`, `opts?`): `number`

Defined in: [protocol/multi-round-trip.ts:789](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/multi-round-trip.ts#L789)
