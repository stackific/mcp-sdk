...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / accessControlsAreCommensurate

# Function: accessControlsAreCommensurate()

> **accessControlsAreCommensurate**(`dataSensitivity`, `appliedControl`): `boolean`

Defined in: [protocol/security.ts:745](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/security.ts#L745)
