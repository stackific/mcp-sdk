...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / promptArgumentNamesOf

# Function: promptArgumentNamesOf()

> **promptArgumentNamesOf**(`prompt`): `string`[]

Defined in: [protocol/completion.ts:779](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L779)
