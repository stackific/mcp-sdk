...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resourceIdentifiersEqual

# Function: resourceIdentifiersEqual()

> **resourceIdentifiersEqual**(`a`, `b`): `boolean`

Defined in: [protocol/authorization.ts:308](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L308)
