...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / serverDeclaresPrompts

# Function: serverDeclaresPrompts()

> **serverDeclaresPrompts**(`serverCaps`): `boolean`

Defined in: [protocol/prompts.ts:136](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/prompts.ts#L136)
