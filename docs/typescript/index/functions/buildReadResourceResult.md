...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildReadResourceResult

# Function: buildReadResourceResult()

> **buildReadResourceResult**(`contents`, `hints`, `opts?`): `object` & `object` & `object`

Defined in: [protocol/resources-read.ts:377](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources-read.ts#L377)
