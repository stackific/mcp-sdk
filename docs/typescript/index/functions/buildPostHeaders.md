...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildPostHeaders

# Function: buildPostHeaders()

> **buildPostHeaders**(`options`): [`HttpHeaders`](../type-aliases/HttpHeaders.md)

Defined in: [transport/http/headers.ts:145](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/headers.ts#L145)
