...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidFileUri

# Function: isValidFileUri()

> **isValidFileUri**(`uri`): `uri is string`

Defined in: [protocol/roots.ts:274](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/roots.ts#L274)
