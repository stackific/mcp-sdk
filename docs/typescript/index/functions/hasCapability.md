...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / hasCapability

# Function: hasCapability()

> **hasCapability**(`declaredCapabilities`, `required`): `boolean`

Defined in: [protocol/capabilities.ts:78](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/capabilities.ts#L78)
