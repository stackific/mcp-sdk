...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isCimdClientIdHostingValid

# Function: isCimdClientIdHostingValid()

> **isCimdClientIdHostingValid**(`clientIdUrl`): `boolean`

Defined in: [protocol/authorization-registration.ts:239](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L239)
