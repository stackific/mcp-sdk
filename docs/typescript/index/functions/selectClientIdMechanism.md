...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / selectClientIdMechanism

# Function: selectClientIdMechanism()

> **selectClientIdMechanism**(`supported`): [`ClientIdMechanism`](../type-aliases/ClientIdMechanism.md)

Defined in: [protocol/authorization-flow.ts:237](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L237)
