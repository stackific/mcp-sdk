...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / parseTokenResponse

# Function: parseTokenResponse()

> **parseTokenResponse**(`value`): [`TokenResponseValidation`](../type-aliases/TokenResponseValidation.md)

Defined in: [protocol/authorization-flow.ts:1386](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L1386)
