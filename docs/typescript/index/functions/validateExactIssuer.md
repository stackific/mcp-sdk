...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateExactIssuer

# Function: validateExactIssuer()

> **validateExactIssuer**(`options`): [`ExactIssuerValidation`](../type-aliases/ExactIssuerValidation.md)

Defined in: [protocol/authorization-registration.ts:1066](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L1066)
