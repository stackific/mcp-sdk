...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / unknownCapabilityFields

# Function: unknownCapabilityFields()

> **unknownCapabilityFields**(`caps`, `known`): `string`[]

Defined in: [protocol/extensions.ts:386](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L386)
