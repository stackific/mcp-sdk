...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateXMcpHeaderName

# Function: validateXMcpHeaderName()

> **validateXMcpHeaderName**(`name`): [`XMcpHeaderNameResult`](../type-aliases/XMcpHeaderNameResult.md)

Defined in: [transport/http/param-headers.ts:113](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/param-headers.ts#L113)
