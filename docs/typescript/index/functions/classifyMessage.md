...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / classifyMessage

# Function: classifyMessage()

> **classifyMessage**(`raw`): [`ClassifiedMessage`](../type-aliases/ClassifiedMessage.md)

Defined in: [jsonrpc/framing.ts:207](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/jsonrpc/framing.ts#L207)
