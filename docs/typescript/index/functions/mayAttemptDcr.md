...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayAttemptDcr

# Function: mayAttemptDcr()

> **mayAttemptDcr**(`metadata`): `boolean`

Defined in: [protocol/authorization-registration.ts:206](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L206)
