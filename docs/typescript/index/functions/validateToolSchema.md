...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateToolSchema

# Function: validateToolSchema()

> **validateToolSchema**(`schema`, `role`, `opts?`): [`ToolSchemaValidation`](../type-aliases/ToolSchemaValidation.md)

Defined in: [protocol/tools.ts:344](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L344)
