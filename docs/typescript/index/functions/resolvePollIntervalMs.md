...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolvePollIntervalMs

# Function: resolvePollIntervalMs()

> **resolvePollIntervalMs**(`pollIntervalMs`, `fallbackMs?`): `number`

Defined in: [protocol/tasks.ts:600](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks.ts#L600)
