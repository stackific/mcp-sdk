...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveGetPromptResultType

# Function: resolveGetPromptResultType()

> **resolveGetPromptResultType**(`result`): `string`

Defined in: [protocol/prompts.ts:461](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/prompts.ts#L461)
