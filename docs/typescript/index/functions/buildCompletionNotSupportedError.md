...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildCompletionNotSupportedError

# Function: buildCompletionNotSupportedError()

> **buildCompletionNotSupportedError**(): [`CompletionError`](../interfaces/CompletionError.md)

Defined in: [protocol/completion.ts:585](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L585)
