...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayAcceptResourceRequest

# Function: mayAcceptResourceRequest()

> **mayAcceptResourceRequest**(`method`, `serverCaps`): `boolean`

Defined in: [protocol/resources.ts:117](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources.ts#L117)
