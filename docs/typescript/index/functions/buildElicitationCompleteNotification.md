...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildElicitationCompleteNotification

# Function: buildElicitationCompleteNotification()

> **buildElicitationCompleteNotification**(`elicitationId`): `objectOutputType`

Defined in: [protocol/elicitation-form.ts:1066](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation-form.ts#L1066)
