...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / stripDefaultTrailingSlash

# Function: stripDefaultTrailingSlash()

> **stripDefaultTrailingSlash**(`uri`, `slashIsSignificant?`): `string`

Defined in: [protocol/authorization.ts:326](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L326)
