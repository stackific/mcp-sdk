...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / lookupMetaKey

# Function: lookupMetaKey()

> **lookupMetaKey**(`key`): [`MetaKeyRegistryEntry`](../interfaces/MetaKeyRegistryEntry.md) \| `undefined`

Defined in: [protocol/registries.ts:355](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/registries.ts#L355)
