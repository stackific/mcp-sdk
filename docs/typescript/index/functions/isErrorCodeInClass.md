...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isErrorCodeInClass

# Function: isErrorCodeInClass()

> **isErrorCodeInClass**(`code`, `cls`): `boolean`

Defined in: [protocol/errors.ts:308](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/errors.ts#L308)
