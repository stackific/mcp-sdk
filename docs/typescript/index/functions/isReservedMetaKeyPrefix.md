...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isReservedMetaKeyPrefix

# Function: isReservedMetaKeyPrefix()

> **isReservedMetaKeyPrefix**(`prefix`): `boolean`

Defined in: [json/meta-key.ts:54](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/json/meta-key.ts#L54)
