...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildHeaderMismatchError

# Function: buildHeaderMismatchError()

> **buildHeaderMismatchError**(`message?`, `data?`): `objectOutputType`

Defined in: [transport/http/responses.ts:329](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L329)
