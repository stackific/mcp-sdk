...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isAppInvokable

# Function: isAppInvokable()

> **isAppInvokable**(`meta`): `boolean`

Defined in: [protocol/ui.ts:528](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L528)
