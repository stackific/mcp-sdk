...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / hostAdvertisesUiRendering

# Function: hostAdvertisesUiRendering()

> **hostAdvertisesUiRendering**(`extensionsMap`): `boolean`

Defined in: [protocol/ui.ts:286](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L286)
