...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / grantTypesWithRefresh

# Function: grantTypesWithRefresh()

> **grantTypesWithRefresh**(`grantTypes`): `string`[]

Defined in: [protocol/authorization-registration.ts:1192](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L1192)
