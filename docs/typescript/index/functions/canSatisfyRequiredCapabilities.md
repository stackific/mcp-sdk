...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / canSatisfyRequiredCapabilities

# Function: canSatisfyRequiredCapabilities()

> **canSatisfyRequiredCapabilities**(`requiredCapabilities`, `clientSupported`): `boolean`

Defined in: [protocol/negotiation.ts:172](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/negotiation.ts#L172)
