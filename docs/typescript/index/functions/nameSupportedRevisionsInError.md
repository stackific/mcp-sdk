...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / nameSupportedRevisionsInError

# Function: nameSupportedRevisionsInError()

> **nameSupportedRevisionsInError**\<`E`\>(`baseError`, `supported`): `E` & `object`

Defined in: [protocol/negotiation.ts:279](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/negotiation.ts#L279)
