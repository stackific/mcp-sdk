...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / dialectIsOnlyChannel

# Function: dialectIsOnlyChannel()

> **dialectIsOnlyChannel**(`grantedPaths`): `boolean`

Defined in: [protocol/ui-host.ts:1169](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L1169)
