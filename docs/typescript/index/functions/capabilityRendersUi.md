...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / capabilityRendersUi

# Function: capabilityRendersUi()

> **capabilityRendersUi**(`value`): `boolean`

Defined in: [protocol/ui.ts:234](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L234)
