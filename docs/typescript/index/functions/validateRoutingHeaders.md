...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateRoutingHeaders

# Function: validateRoutingHeaders()

> **validateRoutingHeaders**(`headers`, `body`): [`HttpValidation`](../type-aliases/HttpValidation.md)

Defined in: [transport/http/headers.ts:319](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/headers.ts#L319)
