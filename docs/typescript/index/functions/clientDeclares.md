...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / clientDeclares

# Function: clientDeclares()

> **clientDeclares**(`caps`, `capability`): `boolean`

Defined in: [protocol/capability-negotiation.ts:179](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/capability-negotiation.ts#L179)
