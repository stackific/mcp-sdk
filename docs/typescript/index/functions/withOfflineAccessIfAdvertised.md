...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / withOfflineAccessIfAdvertised

# Function: withOfflineAccessIfAdvertised()

> **withOfflineAccessIfAdvertised**(`scopes`, `authorizationServerMeta`): `string`[]

Defined in: [protocol/authorization-registration.ts:1213](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L1213)
