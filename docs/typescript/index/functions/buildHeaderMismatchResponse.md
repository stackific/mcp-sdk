...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildHeaderMismatchResponse

# Function: buildHeaderMismatchResponse()

> **buildHeaderMismatchResponse**(`error`, `id?`): [`HttpResponse`](../interfaces/HttpResponse.md)

Defined in: [transport/http/responses.ts:345](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L345)
