...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildReadResourceRequestParams

# Function: buildReadResourceRequestParams()

> **buildReadResourceRequestParams**(`uri`, `opts?`): `objectOutputType`

Defined in: [protocol/resources-read.ts:240](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources-read.ts#L240)
