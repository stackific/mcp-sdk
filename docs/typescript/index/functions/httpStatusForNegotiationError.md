...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / httpStatusForNegotiationError

# Function: httpStatusForNegotiationError()

> **httpStatusForNegotiationError**(`code`): `400` \| `undefined`

Defined in: [protocol/negotiation.ts:61](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/negotiation.ts#L61)
