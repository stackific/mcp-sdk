...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / pickKnownSettings

# Function: pickKnownSettings()

> **pickKnownSettings**(`settings`, `knownKeys`): `Record`\<`string`, `unknown`\>

Defined in: [protocol/extensions.ts:261](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L261)
