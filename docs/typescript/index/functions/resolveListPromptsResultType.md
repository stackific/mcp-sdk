...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveListPromptsResultType

# Function: resolveListPromptsResultType()

> **resolveListPromptsResultType**(`result`): `string`

Defined in: [protocol/prompts.ts:336](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/prompts.ts#L336)
