...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / grantedPermissions

# Function: grantedPermissions()

> **grantedPermissions**(`requested`, `declined?`): `objectOutputType`

Defined in: [protocol/ui-host.ts:1045](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L1045)
