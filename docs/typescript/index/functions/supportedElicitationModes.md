...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / supportedElicitationModes

# Function: supportedElicitationModes()

> **supportedElicitationModes**(`clientCaps`): [`ElicitationMode`](../type-aliases/ElicitationMode.md)[]

Defined in: [protocol/elicitation.ts:419](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation.ts#L419)
