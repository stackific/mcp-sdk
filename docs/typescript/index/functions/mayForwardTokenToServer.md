...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayForwardTokenToServer

# Function: mayForwardTokenToServer()

> **mayForwardTokenToServer**(`tokenIssuer`, `serverIssuer`): `boolean`

Defined in: [protocol/authorization-registration.ts:1041](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L1041)
