...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isVersionSupported

# Function: isVersionSupported()

> **isVersionSupported**(`supportedVersions`, `requested`): `boolean`

Defined in: [protocol/discovery.ts:232](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/discovery.ts#L232)
