...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / selectFirstHintMatch

# Function: selectFirstHintMatch()

> **selectFirstHintMatch**(`hints`, `availableModels`): \{ `hint`: `objectOutputType`; `model`: `string`; \} \| `undefined`

Defined in: [protocol/sampling.ts:292](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/sampling.ts#L292)
