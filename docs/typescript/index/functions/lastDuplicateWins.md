...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / lastDuplicateWins

# Function: lastDuplicateWins()

> **lastDuplicateWins**(`entries`): [`JSONObject`](../type-aliases/JSONObject.md)

Defined in: [json/value.ts:89](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/json/value.ts#L89)
