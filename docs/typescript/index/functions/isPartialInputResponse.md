...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isPartialInputResponse

# Function: isPartialInputResponse()

> **isPartialInputResponse**(`outstandingInputRequests`, `inputResponses`): `boolean`

Defined in: [protocol/tasks-lifecycle.ts:358](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L358)
