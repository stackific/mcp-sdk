...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / methodNotFoundResponse

# Function: methodNotFoundResponse()

> **methodNotFoundResponse**(`id`, `message?`): [`JsonRpcErrorResponse`](../interfaces/JsonRpcErrorResponse.md)

Defined in: [protocol/ui-host.ts:828](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui-host.ts#L828)
