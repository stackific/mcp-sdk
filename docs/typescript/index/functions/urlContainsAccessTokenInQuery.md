...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / urlContainsAccessTokenInQuery

# Function: urlContainsAccessTokenInQuery()

> **urlContainsAccessTokenInQuery**(`requestUrl`): `boolean`

Defined in: [protocol/authorization-flow.ts:1543](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L1543)
