...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / addCalendarMonths

# Function: addCalendarMonths()

> **addCalendarMonths**(`date`, `months`): `Date`

Defined in: [lifecycle/policy.ts:51](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/lifecycle/policy.ts#L51)
