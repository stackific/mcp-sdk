...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildCompleteRequestParams

# Function: buildCompleteRequestParams()

> **buildCompleteRequestParams**(`opts`): `objectOutputType`

Defined in: [protocol/completion.ts:342](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L342)
