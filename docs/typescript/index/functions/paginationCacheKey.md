...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / paginationCacheKey

# Function: paginationCacheKey()

> **paginationCacheKey**(`method`, `cursor`): `string`

Defined in: [protocol/pagination.ts:146](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/pagination.ts#L146)
