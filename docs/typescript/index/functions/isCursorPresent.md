...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isCursorPresent

# Function: isCursorPresent()

> **isCursorPresent**(`cursor`): `boolean`

Defined in: [protocol/pagination.ts:106](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/pagination.ts#L106)
