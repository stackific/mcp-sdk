...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / authorizationAppliesTo

# Function: authorizationAppliesTo()

> **authorizationAppliesTo**(`transport`): `boolean`

Defined in: [protocol/authorization.ts:69](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L69)
