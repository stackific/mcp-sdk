...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isResourceUri

# Function: isResourceUri()

> **isResourceUri**(`value`): `value is string`

Defined in: [protocol/resources.ts:176](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources.ts#L176)
