...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / cspAllowsOrigin

# Function: cspAllowsOrigin()

> **cspAllowsOrigin**(`csp`, `directive`, `origin`): `boolean`

Defined in: [protocol/ui.ts:629](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L629)
