...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / hasNoRefreshToken

# Function: hasNoRefreshToken()

> **hasNoRefreshToken**(`token`): `boolean`

Defined in: [protocol/authorization-flow.ts:1406](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L1406)
