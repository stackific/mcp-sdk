...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / hasExternalRef

# Function: hasExternalRef()

> **hasExternalRef**(`node`, `maxDepth?`): `boolean`

Defined in: [protocol/tools.ts:212](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L212)
