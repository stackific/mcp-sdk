...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / clientSupportsInputRequestKind

# Function: clientSupportsInputRequestKind()

> **clientSupportsInputRequestKind**(`method`, `clientCapabilities`): `boolean`

Defined in: [protocol/multi-round-trip.ts:596](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/multi-round-trip.ts#L596)
