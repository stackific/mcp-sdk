...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / interpretProbeResponse

# Function: interpretProbeResponse()

> **interpretProbeResponse**(`response`): [`ProbeOutcome`](../type-aliases/ProbeOutcome.md)

Defined in: [protocol/negotiation.ts:231](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/negotiation.ts#L231)
