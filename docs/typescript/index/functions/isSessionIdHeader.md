...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isSessionIdHeader

# Function: isSessionIdHeader()

> **isSessionIdHeader**(`name`): `boolean`

Defined in: [transport/http/responses.ts:458](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L458)
