...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidContinuationId

# Function: isValidContinuationId()

> **isValidContinuationId**(`value`): `value is ContinuationId`

Defined in: [protocol/stateless.ts:48](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/stateless.ts#L48)
