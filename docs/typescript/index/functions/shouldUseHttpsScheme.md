...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / shouldUseHttpsScheme

# Function: shouldUseHttpsScheme()

> **shouldUseHttpsScheme**(`directlyFetchable`): `boolean`

Defined in: [protocol/resources-read.ts:643](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources-read.ts#L643)
