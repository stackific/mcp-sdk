...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / authorizationForbiddenFor

# Function: authorizationForbiddenFor()

> **authorizationForbiddenFor**(`transport`): `boolean`

Defined in: [protocol/authorization.ts:82](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization.ts#L82)
