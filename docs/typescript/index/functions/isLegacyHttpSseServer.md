...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isLegacyHttpSseServer

# Function: isLegacyHttpSseServer()

> **isLegacyHttpSseServer**(`firstEventName`): `boolean`

Defined in: [transport/http/responses.ts:637](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L637)
