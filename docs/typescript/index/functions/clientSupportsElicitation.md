...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / clientSupportsElicitation

# Function: clientSupportsElicitation()

> **clientSupportsElicitation**(`clientCaps`): `boolean`

Defined in: [protocol/elicitation.ts:403](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation.ts#L403)
