...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / findSensitiveFormFields

# Function: findSensitiveFormFields()

> **findSensitiveFormFields**(`requestedSchema`): `string`[]

Defined in: [protocol/elicitation-form.ts:1175](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation-form.ts#L1175)
