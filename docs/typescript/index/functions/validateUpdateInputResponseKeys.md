...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateUpdateInputResponseKeys

# Function: validateUpdateInputResponseKeys()

> **validateUpdateInputResponseKeys**(`outstandingInputRequests`, `inputResponses`): `object`

Defined in: [protocol/tasks-lifecycle.ts:304](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L304)
