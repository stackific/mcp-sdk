...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / shouldAttemptStepUp

# Function: shouldAttemptStepUp()

> **shouldAttemptStepUp**(`actor`): `boolean`

Defined in: [protocol/authorization-registration.ts:818](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L818)
