...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / confirmPkceSupport

# Function: confirmPkceSupport()

> **confirmPkceSupport**(`metadata`): \{ `ok`: `true`; \} \| \{ `ok`: `false`; `reason`: `string`; \}

Defined in: [protocol/authorization-flow.ts:805](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L805)
