...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildUiResourceReadResult

# Function: buildUiResourceReadResult()

> **buildUiResourceReadResult**(`contents`, `cache`): `object`

Defined in: [protocol/ui.ts:904](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L904)
