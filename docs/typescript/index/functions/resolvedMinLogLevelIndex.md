...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolvedMinLogLevelIndex

# Function: resolvedMinLogLevelIndex()

> **resolvedMinLogLevelIndex**(`logLevelOptIn`): `number`

Defined in: [protocol/logging.ts:136](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/logging.ts#L136)
