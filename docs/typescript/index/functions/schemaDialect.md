...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / schemaDialect

# Function: schemaDialect()

> **schemaDialect**(`schema`): `string`

Defined in: [protocol/tools.ts:177](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tools.ts#L177)
