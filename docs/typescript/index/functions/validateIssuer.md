...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validateIssuer

# Function: validateIssuer()

> **validateIssuer**(`options`): [`IssuerValidationResult`](../type-aliases/IssuerValidationResult.md)

Defined in: [protocol/authorization-flow.ts:1057](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L1057)
