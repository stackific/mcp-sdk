...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / permissionRequested

# Function: permissionRequested()

> **permissionRequested**(`permissions`, `name`): `boolean`

Defined in: [protocol/ui.ts:707](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L707)
