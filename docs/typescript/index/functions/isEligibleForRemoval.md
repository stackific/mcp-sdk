...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isEligibleForRemoval

# Function: isEligibleForRemoval()

> **isEligibleForRemoval**(`deprecatedSince`, `now`, `expedited?`): `boolean`

Defined in: [lifecycle/policy.ts:74](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/lifecycle/policy.ts#L74)
