...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / decideDegradation

# Function: decideDegradation()

> **decideDegradation**(`opts`): [`DegradationDecision`](../type-aliases/DegradationDecision.md)

Defined in: [protocol/capability-negotiation.ts:416](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/capability-negotiation.ts#L416)
