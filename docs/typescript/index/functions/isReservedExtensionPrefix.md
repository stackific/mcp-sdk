...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isReservedExtensionPrefix

# Function: isReservedExtensionPrefix()

> **isReservedExtensionPrefix**(`prefix`): `boolean`

Defined in: [protocol/extensions.ts:124](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L124)
