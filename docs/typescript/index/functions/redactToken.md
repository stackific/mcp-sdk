...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / redactToken

# Function: redactToken()

> **redactToken**(): `string`

Defined in: [protocol/authorization-registration.ts:1143](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L1143)
