...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isValidExtensionPrefix

# Function: isValidExtensionPrefix()

> **isValidExtensionPrefix**(`prefix`): `boolean`

Defined in: [protocol/extensions.ts:57](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/extensions.ts#L57)
