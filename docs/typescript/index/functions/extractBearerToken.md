...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / extractBearerToken

# Function: extractBearerToken()

> **extractBearerToken**(`headerValue`): `string` \| `undefined`

Defined in: [protocol/authorization-flow.ts:1525](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-flow.ts#L1525)
