...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validatePeerToolCall

# Function: validatePeerToolCall()

> **validatePeerToolCall**(`options`): \{ `ok`: `true`; \} \| \{ `ok`: `false`; `code`: `-32602`; `message`: `string`; `errors`: `string`[]; \}

Defined in: [protocol/security.ts:1315](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/security.ts#L1315)
