...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / methodNotAllowedResponse

# Function: methodNotAllowedResponse()

> **methodNotAllowedResponse**(`httpMethod`): [`HttpResponse`](../interfaces/HttpResponse.md) \| `undefined`

Defined in: [transport/http/responses.ts:492](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/responses.ts#L492)
