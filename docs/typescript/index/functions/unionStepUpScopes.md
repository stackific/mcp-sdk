...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / unionStepUpScopes

# Function: unionStepUpScopes()

> **unionStepUpScopes**(`alreadyGranted`, `challengedScopes`): `string`[]

Defined in: [protocol/authorization-registration.ts:786](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L786)
