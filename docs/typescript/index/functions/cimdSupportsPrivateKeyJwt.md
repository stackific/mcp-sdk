...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / cimdSupportsPrivateKeyJwt

# Function: cimdSupportsPrivateKeyJwt()

> **cimdSupportsPrivateKeyJwt**(`document`): `boolean`

Defined in: [protocol/authorization-registration.ts:250](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L250)
