...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayEmitInputRequestKind

# Function: mayEmitInputRequestKind()

> **mayEmitInputRequestKind**(`method`, `clientCapabilities`): `boolean`

Defined in: [protocol/multi-round-trip.ts:611](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/multi-round-trip.ts#L611)
