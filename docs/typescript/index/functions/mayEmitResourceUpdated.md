...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayEmitResourceUpdated

# Function: mayEmitResourceUpdated()

> **mayEmitResourceUpdated**(`serverCaps`): `boolean`

Defined in: [protocol/resources.ts:156](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/resources.ts#L156)
