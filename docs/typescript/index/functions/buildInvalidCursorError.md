...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildInvalidCursorError

# Function: buildInvalidCursorError()

> **buildInvalidCursorError**(`message?`): `object`

Defined in: [protocol/pagination.ts:122](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/pagination.ts#L122)
