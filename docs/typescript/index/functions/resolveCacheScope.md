...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / resolveCacheScope

# Function: resolveCacheScope()

> **resolveCacheScope**(`scope`): `"public"` \| `"private"`

Defined in: [protocol/caching.ts:121](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/caching.ts#L121)
