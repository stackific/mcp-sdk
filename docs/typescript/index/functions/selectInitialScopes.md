...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / selectInitialScopes

# Function: selectInitialScopes()

> **selectInitialScopes**(`options`): `string` \| `undefined`

Defined in: [protocol/authorization-registration.ts:765](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/authorization-registration.ts#L765)
