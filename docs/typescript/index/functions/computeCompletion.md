...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / computeCompletion

# Function: computeCompletion()

> **computeCompletion**(`ranked`, `opts?`): `objectOutputType`

Defined in: [protocol/completion.ts:516](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L516)
