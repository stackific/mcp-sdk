...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isFresh

# Function: isFresh()

> **isFresh**(`ttlMs`, `receivedAt`, `now`): `boolean`

Defined in: [protocol/caching.ts:142](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/caching.ts#L142)
