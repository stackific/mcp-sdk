...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / buildCompleteResult

# Function: buildCompleteResult()

> **buildCompleteResult**(`config`): `objectOutputType`

Defined in: [protocol/completion.ts:469](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/completion.ts#L469)
