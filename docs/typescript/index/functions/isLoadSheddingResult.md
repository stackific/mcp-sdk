...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isLoadSheddingResult

# Function: isLoadSheddingResult()

> **isLoadSheddingResult**(`result`): `boolean`

Defined in: [protocol/multi-round-trip.ts:186](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/multi-round-trip.ts#L186)
