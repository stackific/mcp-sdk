...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / parseMetaKey

# Function: parseMetaKey()

> **parseMetaKey**(`key`): [`ParsedMetaKey`](../interfaces/ParsedMetaKey.md)

Defined in: [json/meta-key.ts:82](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/json/meta-key.ts#L82)
