...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / describeUnknownErrorCode

# Function: describeUnknownErrorCode()

> **describeUnknownErrorCode**(`error`): `object`

Defined in: [protocol/errors.ts:487](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/errors.ts#L487)
