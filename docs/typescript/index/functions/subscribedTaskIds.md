...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / subscribedTaskIds

# Function: subscribedTaskIds()

> **subscribedTaskIds**(`filter`): `string`[]

Defined in: [protocol/tasks-lifecycle.ts:564](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L564)
