...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / isTaskBackstopElapsed

# Function: isTaskBackstopElapsed()

> **isTaskBackstopElapsed**(`createdAtMs`, `ttlMs`, `nowMs`, `status`): `boolean`

Defined in: [protocol/tasks-lifecycle.ts:742](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L742)
