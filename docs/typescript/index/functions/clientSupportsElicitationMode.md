...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / clientSupportsElicitationMode

# Function: clientSupportsElicitationMode()

> **clientSupportsElicitationMode**(`clientCaps`, `mode`): `boolean`

Defined in: [protocol/elicitation.ts:440](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/elicitation.ts#L440)
