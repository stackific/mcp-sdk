...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / requirementsForRole

# Function: requirementsForRole()

> **requirementsForRole**(`role`): [`ConformanceRequirement`](../interfaces/ConformanceRequirement.md)[]

Defined in: [protocol/conformance-requirements.ts:354](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/conformance-requirements.ts#L354)
