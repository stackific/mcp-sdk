...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / toolsVisibleToModel

# Function: toolsVisibleToModel()

> **toolsVisibleToModel**\<`T`\>(`tools`, `activeSet`): `T`[]

Defined in: [protocol/ui.ts:571](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/ui.ts#L571)
