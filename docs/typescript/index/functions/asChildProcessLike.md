...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / asChildProcessLike

# Function: asChildProcessLike()

> **asChildProcessLike**(`child`): [`ChildProcessLike`](../interfaces/ChildProcessLike.md)

Defined in: [transport/stdio.ts:646](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/stdio.ts#L646)
