...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / mayRateLimitPoll

# Function: mayRateLimitPoll()

> **mayRateLimitPoll**(`lastPolledAtMs`, `nowMs`, `pollIntervalMs`): `boolean`

Defined in: [protocol/tasks-lifecycle.ts:681](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/protocol/tasks-lifecycle.ts#L681)
