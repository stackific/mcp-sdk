...
[@stackific/mcp-sdk](../../README.md) / [index](../README.md) / validatePostBodyFraming

# Function: validatePostBodyFraming()

> **validatePostBodyFraming**(`body`): [`BodyFramingResult`](../type-aliases/BodyFramingResult.md)

Defined in: [transport/http/headers.ts:177](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/transport/http/headers.ts#L177)
