...
[@stackific/mcp-sdk](../../README.md) / [server](../README.md) / bearerAuthGate

# Function: bearerAuthGate()

> **bearerAuthGate**(`options`): [`AuthGate`](../type-aliases/AuthGate.md)

Defined in: [server/auth.ts:92](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/server/auth.ts#L92)
