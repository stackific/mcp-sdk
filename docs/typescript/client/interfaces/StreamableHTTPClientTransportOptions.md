...
[@stackific/mcp-sdk](../../README.md) / [client](../README.md) / StreamableHTTPClientTransportOptions

# Interface: StreamableHTTPClientTransportOptions

Defined in: [client/streamable-http.ts:61](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/client/streamable-http.ts#L61)
...
Defined in: [client/streamable-http.ts:68](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/client/streamable-http.ts#L68)
...
Defined in: [client/streamable-http.ts:70](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/client/streamable-http.ts#L70)
...
Defined in: [client/streamable-http.ts:72](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/client/streamable-http.ts#L72)
...
Defined in: [client/streamable-http.ts:74](https://github.com/stackific/mcp-sdk-v2/blob/main/ts-sdk/src/client/streamable-http.ts#L74)
