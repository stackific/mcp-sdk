...
from stackific.mcp.types.annotations import Annotations, is_valid_annotations
from stackific.mcp.types.base_metadata import BaseMetadata, is_valid_base_metadata, resolve_display_name
...
from stackific.mcp.types.role import ROLES, Role, is_role
