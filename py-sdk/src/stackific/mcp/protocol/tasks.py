...
notifications and cleanup are owned by :mod:`stackific.mcp.protocol.tasks_lifecycle` (S40);
...
tolerate (preserve) additional members, exactly as ``stackific.mcp.protocol.tools`` does.
"""
...
from stackific.mcp.jsonrpc.payload import is_valid_mcp_error
...
from stackific.mcp.protocol.extensions import is_extension_advertised
from stackific.mcp.protocol.multi_round_trip import is_valid_input_request
...
# operational S40 module (:mod:`stackific.mcp.protocol.tasks_lifecycle`) imports them from a
