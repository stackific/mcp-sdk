...
The runtime half of MCP tools on top of :mod:`stackific.mcp.protocol.tools`. Defines the
...
from stackific.mcp.protocol.tools import TOOLS_CALL_METHOD, TOOLS_LIST_CHANGED_METHOD, validate_tool_arguments
