...
``ui://`` resource blocks and launcher tool results) live in :mod:`stackific.mcp.server.ui`. The
...
from stackific.mcp.types.resource_contents import is_valid_resource_contents
