...
* **JSON-Schema validation** of ``tools/call`` arguments/output is performed by an
  ...
  lands with ``stackific.mcp.protocol.tools``.
...
from stackific.mcp.protocol.discovery import DiscoverConfig, build_discover_result
...
from stackific.mcp.protocol.security import validate_resource_uri_access
from stackific.mcp.jsonrpc.payload import RESULT_TYPE_COMPLETE
from stackific.mcp.protocol.multi_round_trip import build_input_required_result
...
#: real JSON-Schema validator is injected once ``stackific.mcp.protocol.tools`` is ported.
